 ...
 * adresse client via OpenRouteService (ORS). Cette route existe pour ne
 * jamais exposer ORS_API_KEY au navigateur — voir lib/osrm.ts côté client,
 * qui appelle cette route au lieu d'appeler ORS directement.
 *
