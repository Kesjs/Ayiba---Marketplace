...
function SearchResults() {
  ...
  const runSearch = useCallback(async (q: string) => {
    ...
    try {
      ...
      // Un vendeur connecté ne doit pas trouver (ni pouvoir acheter) ses
      // propres articles dans la recherche — cf. contrainte DB
      // commandes_client_different_vendeur.
      if (userRole === 'vendeur' && userId) {
        searchQuery = searchQuery.neq('vendeur_id', userId)
      }
