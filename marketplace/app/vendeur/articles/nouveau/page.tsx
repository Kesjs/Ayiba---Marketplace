...
import { 
  ArrowLeft, Upload, X, CheckCircle2, Info
} from "lucide-react";
...
export default function NouveauArticlePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      {success ? (
        <div className="bg-white p-8 md:p-12 rounded-[32px] md:rounded-[40px] border border-teal-100 shadow-xl shadow-teal-500/5 text-center animate-in zoom-in-95 duration-500">
          ...
          {step === 1 ? (
            <div className="bg-white p-6 md:p-8 rounded-[32px] md:rounded-[40px] border border-gray-100 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-gray-700 ml-1">Stock disponible</label>
                  <input 
                    type="number" 
                    name="stock"
                    required
            ...
            <div className="space-y-6">
                  ...
                  {formData.photos.map((photo, i) => (
                    <div key={i} className="relative aspect-square rounded-2xl overflow-hidden border border-gray-100 group">
                      ...
                      <button 
                        ...
                        className="absolute top-2 right-2 w-8 h-8 bg-black/50 text-white rounded-full flex items-center justify-center opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity"
                      >
                        <X size={16} />
                      </button>
                    </div>
              ...
              <div className="bg-amber-50 p-5 md:p-6 rounded-3xl border border-amber-100 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-amber-700/80 leading-relaxed font-medium">Vérifiez bien votre prix et votre stock. Une fois publié, l'article sera immédiatement disponible à la vente.</p>
                </div>
              </div>
