...
export function ReportProductModal({ open, onOpenChange, productId, productName }: ReportProductModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md w-[95%] p-5 md:p-6 rounded-3xl bg-white/95 backdrop-blur-xl shadow-2xl border-0 overflow-hidden">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-gray-900">Signaler un article</DialogTitle>
