...
export function Button({
  ...
  const base =
    "inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 text-[15px] font-semibold whitespace-nowrap transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed";
